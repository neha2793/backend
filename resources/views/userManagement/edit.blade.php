                                                            ...
                                                            <div class="upload mt-4 pr-md-4">
                                                                <div class="dropify-wrapper has-preview">
                                                                    ...
                                                                    <span class="dropify-render">
                                                                        <img src="{{$user->profile_image ? env('API_BASE_URL').$user->profile_image:''}}" id="category-img-tag">
                                                                    </span>
                                                        ...
                                                        <div class="col-xl-10 col-lg-12 col-md-8 mt-md-0 mt-4">
                                                            <div class="form">
                                                                <div class="row">
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control mb-4"  id="name" placeholder="First Name" name="name" value="{{$user->name}}">
                                                                        </div>
                                                                      
                                                                        <div class="form-group">
                                                                            <label for="email">Email</label>
                                                                            <input type="text" class="form-control mb-4"  id="email" placeholder="Email" name="email" value="{{$user->email}}">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group">
                                                                            <label for="lastname">Last Name</label>
                                                                            <input type="text" class="form-control mb-4"  id="lastname" placeholder="Last Name" name="lastname" value="{{$user->lastname}}">
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label for="phone_number">Phone Number</label>
                                                                            <input type="text" class="form-control mb-4"  id="phone_number" name="phone_number" placeholder="Phone Number" value="{{$user->phone_number}}">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control mb-4"  id="wallet_address" name="wallet_address" placeholder="Wallet Address<" value="{{$user->wallet_address}}">
                                                                </div>
