                        ...
                        <form class="text-left" method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form">
                                <div id="username-field" class="field-wrapper input">
                                    ...
                                    <input id="first_name" require name="first_name" type="text" require class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}"  autocomplete="first_name" autofocus placeholder="First Name">
                                    @error('first_name')
                                ...
                                <div id="email-field" class="field-wrapper input">
                                    ...
                                    <input id="email" name="email" require type="text" placeholder="Email" class="@error('email') is-invalid @enderror" value="{{ old('email') }}"  autocomplete="email">
                                    @error('email')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div id="password-field" class="field-wrapper input mb-2">
                                    ...
                                    <input id="password" name="password"  type="password" value="" placeholder="Password" class="@error('password') is-invalid @enderror">
                                    @error('password')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
