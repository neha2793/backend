            ...
            <div class="layout-px-spacing">
                <div class="page-header">
                    <div class="page-title">
                        <h3>Slime Tour Create</h3>
                    </div>
                </div>
                <div class="account-settings-container layout-top-spacing">
                    <form id="general-info" class="section general-info" action="{{route('slime-tour.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                                                            ...
                                                            <div class="upload mt-4 pr-md-4">
                                                                <div class="dropify-wrapper has-preview">
                                                                    ...
                                                                    <span class="dropify-render">
                                                                        <img src="{{asset('public/assets/img/200x200.jpg')}}" id="category-img-tag">
                                                                    </span>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" name="name"  class="form-control mb-4"  id="name" placeholder="Name"  value="">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-sm-6">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" name="date"  class="form-control mb-4 date"  id="date"  placeholder="Date" value="">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                                                                            <label for="location">Location</label>
                                                                            <input type="text" name="location"  class="form-control mb-4"  id="location" placeholder="Location"  value="">
                                                                        </div>
                                                                    </div>
                                                                </div>
