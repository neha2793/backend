                                                            ...
                                                            <div class="upload mt-4 pr-md-4">
                                                                <div class="dropify-wrapper has-preview">
                                                                    ...
                                                                    <span class="dropify-render">
                                                                        <img src="{{$TBLShippingContainer->Featured_Image ? env('API_BASE_URL').$TBLShippingContainer->Featured_Image:''}}" id="category-img-tag">
                                                                    </span>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" readonly class="form-control mb-4"  id="name" placeholder="Name"  value="{{$TBLShippingContainer->Namme}}">
                                                                        </div>
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" readonly class="form-control mb-4"  id="Visit_count" placeholder="Visit_count"  value="{{$TBLShippingContainer->Visit_count}}">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                                                                            <label for="Description">Description</label>
                                                                            <textarea name="" id="" readonly class="form-control mb-4">{{$TBLShippingContainer->Description}}</textarea>
                                                                        </div>
                                                                    </div>
                                                                </div>
