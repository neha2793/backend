        ...
        <div id="content" class="main-content">
            <div class="layout-px-spacing">
                ...
                <div class="account-settings-container layout-top-spacing">
                    <form id="general-info" class="section general-info SCFOrm" method="POST" action="{{route('SC-video-management.store')}}" enctype="multipart/form-data">
                        @csrf
                                                        ...
                                                        <div class="col-xl-2 col-lg-12 col-md-4">
                                                            <div class="upload mt-4 pr-md-4">
                                                                <div class="dropify-wrapper has-preview">
                                                                    ...
                                                                    <input type="file" name="video"  id="input-file-max-fs" class="dropify video" data-default-file="{{asset('public/assets/img/200x200.jpg')}}" data-max-file-size="2M">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-12">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <textarea name="description" class="form-control mb-4" id="" ></textarea>
                                                                        </div>
                                                                        <div class="form-group" id="redirect_lnk" style="display:none">
                                                                            <label for="Redirection_Link">Redirection Link</label>
                                                                            <input type="text" class="form-control mb-4"  id="Redirection_Link" placeholder="Redirection Link" name="redirection_link" value="">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
        ...
        .onchange = function(e) {
            if(e.target.files[0]){
                if(e.target.files[0].type.split('/')[0] == 'video'){
                    ...
                    $('#redirect_lnk').hide();
                    $('.SCFOrm').append('<input type="hidden" name="type" value="Video">')
                    ...
                    $('.SCFOrm').append('<input type="hidden" name="type" value="Image">')
                    let file = e.target.files[0];
                    let blobURL =URL.createObjectURL(e.target.files[0]);
