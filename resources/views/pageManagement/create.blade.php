    ...
    <div id="content" class="main-content">
        <div class="layout-px-spacing">
            ...
            <div class="account-settings-container layout-top-spacing">
                <form id="general-info" class="" action="{{route('page-management.store')}}" method="POST">
                    @csrf
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text"  class="form-control mb-4" name="title"  id="title" placeholder="Title" >
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-sm-12">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <textarea  class="form-control mb-4"  id="body" name="body"></textarea>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
