                            ...
                            <div class="w-chart">
                                <div class="w-chart-section">
                                    <div class="w-detail">
                                        ...
                                        <p class="w-stats">{{number_format(count($users))}}</p>
                                    </div>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12 layout-spacing">
                        <div class="widget widget-card-four">
                            <div class="widget-content">
                                <div class="w-content">
                                    <div class="w-info">
                                        <h6 class="value">{{'$ '. number_format(count($transaction))}}</h6>
                                        <p class="">Expenses</p>
                                    </div>
                                    <div class="">
                                        <div class="w-icon">
                                ...
                                <!-- <div class="progress" style="background: linear-gradient(to right, #0081ff 0%, #0045ff 100%);">
